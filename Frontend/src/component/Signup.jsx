...
export default function Signup(props) {
  ...
  return (
	  <div className="flex min-h-full flex-1  justify-center  py-12 lg:px-8 ml-36">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm ">
		<img src="src\component\img\Sign up.gif" className=" img" alt="Logo" />
      {/* <img src="src\component\img\ILl1.png" className="h-60  image-to-slide-and-bounce " alt="Logo" /> */}

        {/* Your Company Logo */}
      </div>

      <div className="mt-10 sm:mx-auto sm:w-full p-4 sm:max-w-sm borderr">
